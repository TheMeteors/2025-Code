  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()){
             ...
             double power = Math.sqrt(Math.pow(gamepad1.right_stick_x, 2) + Math.pow(gamepad1.left_stick_y, 2));
            double theta = -Math.atan2(gamepad1.left_stick_y,gamepad1.right_stick_x);
